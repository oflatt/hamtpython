...
import gc, sys
from variables import repititionfactor
...
numofiterations = 10000*repititionfactor
print("Iterations,Number of Keys,4,8,16,32,64,128")
print(str(numofiterations) + ",4,", end='')
testtimes(4, 4, 2, numofiterations)
testtimes(4, 8, 3, numofiterations)
testtimes(4, 16, 4, numofiterations)
testtimes(4, 32, 5, numofiterations)
testtimes(4, 64, 6, numofiterations)
testtimes(4, 128, 7, numofiterations)
print("")
numofiterations = 500*repititionfactor
print(str(numofiterations) + ",64,", end='')
testtimes(64, 4, 2, numofiterations)
testtimes(64, 8, 3, numofiterations)
testtimes(64, 16, 4, numofiterations)
testtimes(64, 32, 5, numofiterations)
testtimes(64, 64, 6, numofiterations)
testtimes(64, 128, 7, numofiterations)
print("")
numofiterations = 50*repititionfactor
print(str(numofiterations) + ",512,", end='')
testtimes(512, 4, 2, numofiterations)
testtimes(512, 8, 3, numofiterations)
testtimes(512, 16, 4, numofiterations)
testtimes(512, 32, 5, numofiterations)
testtimes(512, 64, 6, numofiterations)
testtimes(512, 128, 7, numofiterations)
print("")
numofiterations = 10*repititionfactor
print(str(numofiterations) + ",2048,", end='')
testtimes(2048, 4, 2, numofiterations)
testtimes(2048, 8, 3, numofiterations)
testtimes(2048, 16, 4, numofiterations)
testtimes(2048, 32, 5, numofiterations)
testtimes(2048, 64, 6, numofiterations)
testtimes(2048, 128, 7, numofiterations)
